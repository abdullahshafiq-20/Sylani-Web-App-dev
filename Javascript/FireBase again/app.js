...
function createdata(inputvalue, id) {
    ...
    <li class="">${inputvalue}
        <span id="button_s">
        <button class="editbtn" id='${id}' onclick="editbtn(this)"><i class="fa-solid fa-pen"></i></button>
        <button class="dltbtn" id='${id}' onclick="dltbtn(this)"><i class="fa-regular fa-circle-xmark"></i></button>
        </span>
    </li>
</ul>`;
    return listui;
